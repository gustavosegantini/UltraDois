        ...
        <div class="modal">
            ...
            <table id="tabelaCodigos">
                ...
                <tbody>
                    ...
                    $buscador = "%{$buscador}%";
                    $stmt = $conn->prepare('SELECT Codigos.ID_Codigo, Codigos.Codigo, Codigos.Gerado, Codigos.data_gerado, Codigos.Utilizado, Codigos.data_utilizado, produtos.nome, produtos.tamanho, produtos.preco
                    FROM Codigos
                    INNER JOIN produtos ON Codigos.produto_id = produtos.ID
                    WHERE Codigos.Codigo LIKE ? OR Codigos.Utilizado LIKE ? OR Codigos.Gerado LIKE ?');
